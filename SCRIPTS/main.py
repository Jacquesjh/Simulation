...
#risk               = (daily_deaths + daily_cases)*(1/(hospital_occupancy*total_population) + 1/total_population)
'''
...
if __name__ == '__main__':
    ...
    for day in range(DAYS):
        ...
        update_population_resistance(population_list)
        update_population_risk(population_list, risk)
